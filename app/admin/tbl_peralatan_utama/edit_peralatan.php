...
<div class="card ">
	<div class="card-header text-white bg-warning">EDIT Peralatan</div>
	<div class="card-body">
		<h4 class="card-title">EDIT Data Peralatan</h4><hr>
		<form class="form" id="frmTambahAlat">
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label for="first-name-column">Nama Alat:</label>
                            <input type="text" id="alatNama" value="<?=$dataAlat['nama_alat']?>"  class="form-control" placeholder="Mis: Router" name="fname-column" required="required">
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label for="first-name-column">Tahun Pembelian:</label>
                            <input type="date" id="alatTahun" value="<?=$dataAlat['tahun_pembelian']?>" class="form-control"  placeholder="mis: 2021" >
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="alatJenis" value="<?=$dataAlat['jenis_alat']?>" class="form-control"  placeholder="ROUTER" >
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="alatUsername" value="<?=$dataAlat['username']?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="alatpassword" value="<?=$dataAlat['password']?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="alatDeskripsi" ><?=$dataAlat[
                                'spesifikasi']?></textarea>
                        </div>
                    </div>

                    <button class="btn btn-primary" class="btn btn-success"> update</button>
                </div>
                <div class="pesan"></div>
        </form>
		<!--  -->
...
<script type="text/javascript">
	$(document).ready(function($) {
		$("#frmTambahAlat").submit(function(e) {
			...
			var a = confirm("Apakah anda ingin update data ini ??");
			if (a) {
				$.post('./route/', {
